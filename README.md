...
## Exercises
1. Edit this README file. Include a sentence at the bottom of the file with your name, major, and an unpopular food opinion you have. Use the pencil icon to edit this file, and select the option that creates a new branch and makes a pull request. 
...
5. If interested, try these exercises using the command line! (We will figure this out as a team)
